...
const Shuffle: React.FC<ShuffleProps> = ({
  ...
  useGSAP(
    () => {
      ...
      // Hitung start trigger untuk ScrollTrigger
      ...
      const build = () => {
        ...
        // Split per karakter menggunakan GSAP SplitText
  ...
  // Tidak memaksa ukuran/case — ikut className pemanggil
  const baseTw =
    "inline-block whitespace-normal break-words will-change-transform normal-case text-inherit leading-none";
  ...
  // Gunakan ElementType agar TS tidak error
  const TagComp = (tag || "p") as React.ElementType;

  return React.createElement(
    TagComp as any,
    { ref: ref as any, className: classes, style: commonStyle } as any,
    text
  );
};
